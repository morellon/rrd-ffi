...
describe RRD::Base do
  ...
  it "create a rrd file using dsl" do
  ...
  it "create a rrd file using create!" do
    expect(File).not_to be_file(RRD_FILE)
  ...
  it "update the rrd file with data" do
    time = Time.now
  ...
  it "fetch data from rrd file" do
  ...
  it "return the rrd file information" do
  ...
  it "resize a RRA from rrd file" do
  ...
  it "return the starting date" do
  ...
  context "when using bang methods" do
    ...
    it "expect { $1 }.to raise error if the normal method result is false" do
